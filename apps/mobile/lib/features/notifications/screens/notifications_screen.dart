...
class NotificationsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return t.isSport
        ? _SportNotifications(t: t)
        : _GlassNotifications(t: t);
  }
}

class _SportNotifications extends StatelessWidget {
  final AppTokens t;
  const _SportNotifications({required this.t});
                  ...
                  child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: n.iconColor(t).withValues(alpha: 0.15),
                        shape: BoxShape.circle,
                      ),
                      child: Center(
                        child: Icon(n.icon, size: 16, color: n.iconColor(t)),
                      ),
                    ),
                        ...
                        children: [
                          Row(children: [
                            Expanded(
                              child: Text(
                                n.title,
                                style: t.h2Style.copyWith(fontSize: 13),
                              ),
                            ),
                            Text(
                              n.timestamp,
