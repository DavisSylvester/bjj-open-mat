...
function FromRegExp(left, right) {
  const L = exports_type.IsRegExp(left) ? String() : left;
  const R = exports_type.IsRegExp(right) ? String() : right;
  return Visit3(L, R);
}
...
// src/enums/belt-rank.mts
var BeltRank = Type.Union([Type.Literal("white"), Type.Literal("blue"), Type.Literal("purple"), Type.Literal("brown"), Type.Literal("black")], { $id: "BeltRank" });
// src/enums/skill-level.mts
var SkillLevel = Type.Union([Type.Literal("all"), Type.Literal("beginner"), Type.Literal("intermediate"), Type.Literal("advanced")], { $id: "SkillLevel" });
// src/enums/gi-type.mts
var GiType = Type.Union([Type.Literal("gi"), Type.Literal("nogi"), Type.Literal("both")], { $id: "GiType" });
// src/enums/class-type.mts
var ClassType = Type.Union([Type.Literal("fundamentals"), Type.Literal("all_levels"), Type.Literal("advanced"), Type.Literal("gi"), Type.Literal("nogi"), Type.Literal("kids"), Type.Literal("womens"), Type.Literal("competition"), Type.Literal("private"), Type.Literal("other")], { $id: "ClassType" });
// src/enums/open-mat-status.mts
var OpenMatStatus = Type.Union([Type.Literal("live"), Type.Literal("hidden")], { $id: "OpenMatStatus" });
// src/enums/user-role.mts
var UserRole = Type.Union([Type.Literal("practitioner"), Type.Literal("gym_owner"), Type.Literal("admin")], { $id: "UserRole" });
// src/enums/notification-type.mts
var NotificationType = Type.Union([Type.Literal("rsvp"), Type.Literal("review"), Type.Literal("session_update"), Type.Literal("system")], { $id: "NotificationType" });
// src/enums/review-category.mts
var ReviewCategory = Type.Union([
  Type.Literal("instruction"),
  Type.Literal("cleanliness"),
  Type.Literal("variety"),
  Type.Literal("worth_returning"),
  Type.Literal("overall")
], { $id: "ReviewCategory" });
// src/enums/check-in-location-status.mts
var CheckInLocationStatus = Type.Union([Type.Literal("verified"), Type.Literal("far"), Type.Literal("no_location")], { $id: "CheckInLocationStatus" });
// src/enums/gender.mts
var Gender = Type.Union([Type.Literal("male"), Type.Literal("female")], { $id: "Gender" });
// src/enums/weight-division.mts
var WeightDivision = Type.Union([
  Type.Literal("rooster"),
  Type.Literal("light_feather"),
  Type.Literal("feather"),
  Type.Literal("light"),
  Type.Literal("middle"),
  Type.Literal("medium_heavy"),
  Type.Literal("heavy"),
  Type.Literal("super_heavy"),
  Type.Literal("ultra_heavy")
], { $id: "WeightDivision" });
// src/enums/report-type.mts
var ReportType = Type.Union([Type.Literal("bug"), Type.Literal("feature")], { $id: "ReportType" });
// src/enums/gym-role.mts
var GymRole = Type.Union([Type.Literal("member"), Type.Literal("coach"), Type.Literal("owner")], { $id: "GymRole" });
// src/enums/membership-status.mts
var MembershipStatus = Type.Union([Type.Literal("pending"), Type.Literal("active")], { $id: "MembershipStatus" });
// src/enums/join-method.mts
var JoinMethod = Type.Union([Type.Literal("self"), Type.Literal("code"), Type.Literal("invite")], { $id: "JoinMethod" });
// src/schemas/geo-location.mts
var GeoLocation = Type.Object({ lat: Type.Number({ minimum: -90, maximum: 90 }), lng: Type.Number({ minimum: -180, maximum: 180 }) }, { $id: "GeoLocation" });
// src/schemas/user.mts
var UserSettings = Type.Object({
  theme: Type.Union([Type.Literal("sport"), Type.Literal("glass")], { default: "glass" }),
  notifyRsvp: Type.Boolean({ default: true }),
  notifySessionUpdates: Type.Boolean({ default: true })
}, { $id: "UserSettings" });
var UserPreferences = Type.Object({
  defaultWhen: Type.Optional(Type.String()),
  defaultWithinMi: Type.Optional(Type.Number({ minimum: 1, maximum: 100 })),
  defaultGiType: Type.Optional(Type.String())
}, { $id: "UserPreferences" });
var User = Type.Object({
  ...
  beltRank: Type.Optional(BeltRank),
  beltStripes: Type.Optional(Type.Integer({ minimum: 0, maximum: 4 })),
  verifiedBeltRank: Type.Optional(BeltRank),
  verifiedBeltStripes: Type.Optional(Type.Integer({ minimum: 0, maximum: 4 })),
  verifiedByGymId: Type.Optional(Type.String()),
  verifiedAt: Type.Optional(Type.String()),
  weight: Type.Optional(Type.String()),
  city: Type.Optional(Type.String()),
  state: Type.Optional(Type.String()),
  gender: Type.Optional(Gender),
  weightValue: Type.Optional(Type.Number()),
  weightUnit: Type.Optional(Type.Union([Type.Literal("lb"), Type.Literal("kg")])),
  weightDivision: Type.Optional(WeightDivision),
  weightDivisionContext: Type.Optional(Type.Union([Type.Literal("gi"), Type.Literal("nogi")])),
  bio: Type.Optional(Type.String()),
  avatarUrl: Type.Optional(Type.String()),
  homeGymId: Type.Optional(Type.String()),
...
// src/schemas/open-mat.mts
var OpenMat = Type.Object({
  id: Type.String(),
  gymId: Type.String(),
  ...
  specificDate: Type.Optional(Type.String({ description: "ISO date YYYY-MM-DD" })),
  maxParticipants: Type.Optional(Type.Integer({ minimum: 0 })),
  skillLevel: SkillLevel,
  giType: GiType,
  isCancelled: Type.Boolean({ default: false }),
  verified: Type.Boolean({ default: false }),
  status: Type.Union([Type.Literal("live"), Type.Literal("hidden")], { default: "live" }),
  feeCents: Type.Optional(Type.Integer({ minimum: 0 })),
  attendeeCount: Type.Optional(Type.Integer({ minimum: 0 })),
  gymName: Type.Optional(Type.String()),
  distanceKm: Type.Optional(Type.Number({ minimum: 0 })),
  createdAt: Type.Optional(Type.String())
}, { $id: "OpenMat" });
// src/schemas/open-mat-detail.mts
var OpenMatDetail = Type.Composite([
  OpenMat,
  Type.Object({
    ...
    state: Type.String(),
    postalCode: Type.Optional(Type.String()),
    gymRating: Type.Optional(Type.Number({ minimum: 0, maximum: 5 }))
  })
], { $id: "OpenMatDetail" });
// src/schemas/attendee.mts
var Attendee = Type.Object({
  userId: Type.String(),
  name: Type.String(),
  beltRank: BeltRank,
  beltStripes: Type.Optional(Type.Integer({ minimum: 0, maximum: 4 })),
...
// src/schemas/review.mts
var CategoryRatings = Type.Object({
  instruction: Type.Number({ minimum: 0, maximum: 5 }),
  cleanliness: Type.Number({ minimum: 0, maximum: 5 }),
  variety: Type.Number({ minimum: 0, maximum: 5 }),
  worth_returning: Type.Number({ minimum: 0, maximum: 5 }),
  overall: Type.Number({ minimum: 0, maximum: 5 })
}, { $id: "CategoryRatings" });
// src/schemas/check-in.mts
var CheckIn = Type.Object({
  id: Type.String(),
  openMatId: Type.String(),
  userId: Type.String(),
  sessionDate: Type.String(),
  checkedInAt: Type.String(),
  rating: Type.Optional(Type.Integer({ minimum: 1, maximum: 5 })),
  review: Type.Optional(Type.String()),
  categoryRatings: Type.Optional(CategoryRatings),
  reviewedAt: Type.Optional(Type.String()),
  latitude: Type.Optional(Type.Number()),
  longitude: Type.Optional(Type.Number()),
  gpsAccuracyM: Type.Optional(Type.Number()),
  locationStatus: Type.Optional(CheckInLocationStatus),
  distanceM: Type.Optional(Type.Number()),
  gymId: Type.Optional(Type.String()),
  gymCity: Type.Optional(Type.String()),
  gymState: Type.Optional(Type.String()),
  note: Type.Optional(Type.String()),
  rounds: Type.Optional(Type.Integer({ minimum: 0 })),
  intensity: Type.Optional(Type.Integer({ minimum: 1, maximum: 5 })),
  partners: Type.Optional(Type.Integer({ minimum: 0 })),
  gymName: Type.Optional(Type.String()),
  openMatTitle: Type.Optional(Type.String()),
  userName: Type.Optional(Type.String()),
  beltRank: Type.Optional(BeltRank),
  createdAt: Type.Optional(Type.String())
}, { $id: "CheckIn" });
// src/schemas/gym-membership.mts
var GymMembership = Type.Object({
  id: Type.String(),
  gymId: Type.String(),
  userId: Type.String(),
  status: Type.Optional(Type.Union([MembershipStatus], { default: "active" })),
  verifiedMember: Type.Boolean({ default: false }),
  gymRole: Type.Optional(Type.Union([GymRole], { default: "member" })),
  isHome: Type.Boolean({ default: false }),
  visibleInRoster: Type.Boolean({ default: true }),
  joinMethod: Type.Optional(Type.Union([JoinMethod], { default: "self" })),
  joinedAt: Type.String(),
  createdAt: Type.Optional(Type.String())
}, { $id: "GymMembership" });
// src/schemas/belt-promotion.mts
var BeltPromotion = Type.Object({
  id: Type.String(),
  userId: Type.String(),
  gymId: Type.String(),
  beltRank: BeltRank,
  beltStripes: Type.Integer({ minimum: 0, maximum: 4 }),
  promotedByUserId: Type.String(),
  promotedAt: Type.String(),
  note: Type.Optional(Type.String())
}, { $id: "BeltPromotion" });
// src/schemas/gym-class.mts
var GymClass = Type.Object(
  {
    id: Type.String(),
    gymId: Type.String(),
    title: Type.String({ minLength: 1 }),
    classType: ClassType,
    classTypeLabel: Type.Optional(Type.String()),
    description: Type.Optional(Type.String()),
    giType: GiType,
    skillLevel: SkillLevel,
    instructorUserId: Type.Optional(Type.String()),
    instructorName: Type.Optional(Type.String()),
    isRecurring: Type.Boolean({ default: true }),
    dayOfWeek: Type.Optional(Type.Integer({ minimum: 0, maximum: 6 })),
    startTime: Type.String({ description: "24h HH:mm" }),
    endTime: Type.String({ description: "24h HH:mm" }),
    specificDate: Type.Optional(Type.String({ description: "ISO YYYY-MM-DD (one-off)" })),
    capacity: Type.Optional(Type.Integer({ minimum: 0 })),
    status: Type.Optional(Type.Union([Type.Literal("active"), Type.Literal("archived")], { default: "active" })),
    createdAt: Type.Optional(Type.String()),
  },
  { $id: "GymClass" },
);
// src/schemas/class-occurrence.mts
var ClassOccurrence = Type.Object(
  {
    id: Type.String(),
    classId: Type.String(),
    gymId: Type.String(),
    date: Type.String({ description: "ISO YYYY-MM-DD" }),
    status: Type.Optional(Type.Union([Type.Literal("scheduled"), Type.Literal("cancelled")], { default: "scheduled" })),
...
// src/schemas/roster-member.mts
var RosterMember = Type.Object({
  userId: Type.String(),
  name: Type.String(),
  beltRank: Type.Optional(BeltRank),
  beltStripes: Type.Optional(Type.Integer({ minimum: 0, maximum: 4 })),
  ...
  avatarUrl: Type.Optional(Type.String()),
  gymRole: GymRole,
  verifiedMember: Type.Boolean(),
  hasProfile: Type.Boolean()
}, { $id: "RosterMember" });
// src/schemas/favorite.mts
var Favorite = Type.Object({ userId: Type.String(), gymId: Type.String(), createdAt: Type.String() }, { $id: "Favorite" });
// src/schemas/notification.mts
var Notification = Type.Object({
  id: Type.String(),
  userId: Type.String(),
...
// src/schemas/report.mts
var Report = Type.Object({
  id: Type.String(),
  userId: Type.String(),
  type: ReportType,
  title: Type.String(),
  description: Type.String(),
  status: Type.Literal("open", { default: "open" }),
  createdAt: Type.String(),
  audioKeys: Type.Optional(Type.Array(Type.String())),
  githubIssueNumber: Type.Optional(Type.Number()),
  githubIssueUrl: Type.Optional(Type.String())
}, { $id: "Report" });
// src/schemas/lead.mts
var Utm = Type.Object({
  source: Type.Optional(Type.String()),
  medium: Type.Optional(Type.String()),
  campaign: Type.Optional(Type.String())
}, { $id: "Utm" });
var WaitlistLeadStatus = Type.Union([Type.Literal("pending"), Type.Literal("confirmed")], {
  $id: "WaitlistLeadStatus"
});
var WaitlistLead = Type.Object({
  id: Type.String(),
  email: Type.String({ format: "email" }),
  status: WaitlistLeadStatus,
  source: Type.Optional(Type.String()),
  utm: Type.Optional(Utm),
  createdAt: Type.String(),
  confirmationSentAt: Type.Optional(Type.String())
}, { $id: "WaitlistLead" });
var GymLeadStatus = Type.Union([Type.Literal("new"), Type.Literal("contacted")], { $id: "GymLeadStatus" });
var GymLead = Type.Object({
  id: Type.String(),
  gymName: Type.String(),
...
// src/schemas/requests/user-requests.mts
var UpdateUserRequest = Type.Partial(Type.Object({
  displayName: Type.String(),
  role: UserRole,
  beltRank: BeltRank,
  beltStripes: Type.Integer({ minimum: 0, maximum: 4 }),
  ...
  weightUnit: Type.Union([Type.Literal("lb"), Type.Literal("kg")]),
  weightDivision: WeightDivision,
  weightDivisionContext: Type.Union([Type.Literal("gi"), Type.Literal("nogi")]),
  bio: Type.String(),
  avatarUrl: Type.String(),
  homeGymId: Type.String(),
  birthday: Type.String(),
  preferences: UserPreferences
}), { $id: "UpdateUserRequest" });
var UpdateSettingsRequest = Type.Partial(UserSettings, { $id: "UpdateSettingsRequest" });
// src/schemas/requests/gym-requests.mts
var CreateGymRequest = Type.Object({
...
var UpdateGymRequest = Type.Partial(CreateGymRequest, { $id: "UpdateGymRequest" });
var LogoContentType = Type.Union([Type.Literal("image/png"), Type.Literal("image/jpeg"), Type.Literal("image/webp")], { $id: "LogoContentType" });
var LogoUploadUrlRequest = Type.Object({
  contentType: LogoContentType
}, { $id: "LogoUploadUrlRequest" });
var LogoUploadUrlResponse = Type.Object({
  uploadUrl: Type.String(),
  publicUrl: Type.String(),
  key: Type.String()
}, { $id: "LogoUploadUrlResponse" });
var NearbyQuery = Type.Object({
  lat: Type.Number(),
  lng: Type.Number(),
  radiusKm: Type.Optional(Type.Number({ minimum: 1, maximum: 500, default: 25 }))
}, { $id: "NearbyQuery" });
var GymListQuery = Type.Object({
  mine: Type.Optional(Type.Boolean()),
  page: Type.Optional(Type.Number({ minimum: 1, default: 1 })),
  limit: Type.Optional(Type.Number({ minimum: 1, maximum: 100, default: 20 }))
}, { $id: "GymListQuery" });
// src/schemas/requests/open-mat-requests.mts
var NewGymInput = Type.Object({
  name: Type.String({ minLength: 1 }),
  address: Type.String({ minLength: 1 }),
  city: Type.Optional(Type.String()),
  state: Type.Optional(Type.String()),
...
var CreateOpenMatRequest = Type.Object({
  gymId: Type.Optional(Type.String()),
  newGym: Type.Optional(NewGymInput),
  hostId: Type.Optional(Type.String()),
  title: Type.String({ minLength: 1 }),
  description: Type.Optional(Type.String()),
  dayOfWeek: Type.Optional(Type.Integer({ minimum: 0, maximum: 6 })),
  ...
  specificDate: Type.Optional(Type.String()),
  maxParticipants: Type.Optional(Type.Integer({ minimum: 0 })),
  skillLevel: Type.Optional(SkillLevel),
  giType: Type.Optional(GiType),
  feeCents: Type.Optional(Type.Integer({ minimum: 0 }))
}, { $id: "CreateOpenMatRequest" });
var UpdateOpenMatRequest = Type.Partial(Type.Omit(CreateOpenMatRequest, ["newGym"]), { $id: "UpdateOpenMatRequest" });
var OpenMatListQuery = Type.Object({
  dayOfWeek: Type.Optional(Type.Number({ minimum: 0, maximum: 6 })),
  giType: Type.Optional(GiType),
  skillLevel: Type.Optional(SkillLevel),
  mine: Type.Optional(Type.Boolean({ description: "sessions at gyms the caller owns" })),
  gymId: Type.Optional(Type.String({ description: "sessions at a specific gym" })),
  page: Type.Optional(Type.Number({ minimum: 1, default: 1 })),
  limit: Type.Optional(Type.Number({ minimum: 1, maximum: 100, default: 20 })),
  status: Type.Optional(OpenMatStatus),
  verified: Type.Optional(Type.Boolean()),
  submittedByMe: Type.Optional(Type.Boolean({ description: "sessions the caller submitted (hostId)" })),
  q: Type.Optional(Type.String({ description: "free-text: title + gymName" })),
  free: Type.Optional(Type.Boolean({ description: "feeCents 0 or absent" })),
  startDate: Type.Optional(Type.String({ description: "ISO date; When range start" })),
  endDate: Type.Optional(Type.String({ description: "ISO date; When range end" })),
  lat: Type.Optional(Type.Number({ minimum: -90, maximum: 90 })),
  lng: Type.Optional(Type.Number({ minimum: -180, maximum: 180 })),
  radiusKm: Type.Optional(Type.Number({ minimum: 1, maximum: 500 })),
  zip: Type.Optional(Type.String({ description: "geocoded to a point server-side" })),
  city: Type.Optional(Type.String({ description: "exact (case-insensitive) city match" })),
  state: Type.Optional(Type.String({ description: "exact (case-insensitive) state match" }))
}, { $id: "OpenMatListQuery" });
var RsvpRequest = Type.Object({ sessionDate: Type.String() }, { $id: "RsvpRequest" });
// src/schemas/requests/check-in-requests.mts
var ReviewRequest = Type.Object({
  rating: Type.Integer({ minimum: 1, maximum: 5 }),
  review: Type.Optional(Type.String()),
  categoryRatings: CategoryRatings
}, { $id: "ReviewRequest" });
var SessionDateQuery = Type.Object({ sessionDate: Type.Optional(Type.String()), date: Type.Optional(Type.String()) }, { $id: "SessionDateQuery" });
var AttendeesQuery = Type.Object({
  sessionDate: Type.Optional(Type.String()),
  date: Type.Optional(Type.String()),
  page: Type.Optional(Type.Number({ minimum: 1, default: 1 })),
  limit: Type.Optional(Type.Number({ minimum: 1, maximum: 100, default: 12 }))
}, { $id: "AttendeesQuery" });
var PageQuery = Type.Object({
  page: Type.Optional(Type.Number({ minimum: 1, default: 1 })),
  limit: Type.Optional(Type.Number({ minimum: 1, maximum: 100, default: 20 }))
}, { $id: "PageQuery" });
var CreateCheckInRequest = Type.Object({
  sessionDate: Type.String(),
  latitude: Type.Optional(Type.Number()),
  longitude: Type.Optional(Type.Number()),
  gpsAccuracyM: Type.Optional(Type.Number()),
...
// src/schemas/requests/notification-requests.mts
var NotificationListQuery = Type.Object({
  unread: Type.Optional(Type.Boolean()),
  page: Type.Optional(Type.Number({ minimum: 1, default: 1 })),
  limit: Type.Optional(Type.Number({ minimum: 1, maximum: 100, default: 20 }))
}, { $id: "NotificationListQuery" });
// src/schemas/requests/report-requests.mts
var CreateReportRequest = Type.Object({
  type: ReportType,
  title: Type.String({ minLength: 3, maxLength: 120 }),
  description: Type.String({ minLength: 10, maxLength: 4000 }),
  audioKeys: Type.Optional(Type.Array(Type.String(), { maxItems: 20 }))
}, { $id: "CreateReportRequest" });
var AudioUploadUrlRequest = Type.Object({
  contentType: Type.Union([Type.Literal("audio/mp4"), Type.Literal("audio/m4a"), Type.Literal("audio/aac")])
}, { $id: "AudioUploadUrlRequest" });
var TranscribeAudioRequest = Type.Object({ audioKey: Type.String({ minLength: 1 }) }, { $id: "TranscribeAudioRequest" });
// src/schemas/requests/auth-sync-request.mts
var AuthSyncRequest = Type.Object({
  displayName: Type.Optional(Type.String()),
  email: Type.Optional(Type.String({ format: "email" })),
  avatarUrl: Type.Optional(Type.String())
}, { $id: "AuthSyncRequest" });
// src/schemas/requests/lead-requests.mts
var WaitlistLeadRequest = Type.Object({
  email: Type.String({ format: "email" }),
  source: Type.Optional(Type.String()),
  utm: Type.Optional(Utm),
  hp: Type.Optional(Type.String())
}, { $id: "WaitlistLeadRequest" });
var GymLeadRequest = Type.Object({
  gymName: Type.String({ minLength: 1 }),
  ownerName: Type.Optional(Type.String()),
  ownerEmail: Type.String({ format: "email" }),
  city: Type.Optional(Type.String()),
  state: Type.Optional(Type.String()),
...
var LeadResponse = Type.Object({
  status: Type.Union([Type.Literal("confirmed"), Type.Literal("new")])
}, { $id: "LeadResponse" });
// src/schemas/requests/membership-requests.mts
var UpdateMembershipRequest = Type.Object({
  verifiedMember: Type.Optional(Type.Boolean()),
  gymRole: Type.Optional(GymRole)
}, { $id: "UpdateMembershipRequest" });
var UpdateMyMembershipRequest = Type.Object({
  visibleInRoster: Type.Optional(Type.Boolean()),
  isHome: Type.Optional(Type.Boolean())
}, { $id: "UpdateMyMembershipRequest" });
var PromoteBeltRequest = Type.Object({
  beltRank: BeltRank,
  beltStripes: Type.Integer({ minimum: 0, maximum: 4 }),
  note: Type.Optional(Type.String())
}, { $id: "PromoteBeltRequest" });
// src/schemas/responses/envelope.mts
var ListMeta = Type.Object({ page: Type.Integer({ minimum: 1 }), limit: Type.Integer({ minimum: 1 }), total: Type.Integer({ minimum: 0 }) }, { $id: "ListMeta" });
var DataResponse = (data) => Type.Object({ data });
var ListResponse = (item) => Type.Object({ data: Type.Array(item), meta: ListMeta });
var ErrorResponse = Type.Object({
  error: Type.Object({
    code: Type.String(),
    message: Type.String(),
...
// src/schemas/responses/health.mts
var HealthResponse = Type.Object({ status: Type.Literal("ok"), uptimeSeconds: Type.Number() }, { $id: "HealthResponse" });
var ReadyResponse = Type.Object({ status: Type.Union([Type.Literal("ready"), Type.Literal("degraded")]), checks: Type.Record(Type.String(), Type.Boolean()) }, { $id: "ReadyResponse" });
// src/schemas/responses/report-responses.mts
var AudioUploadUrlResponse = Type.Object({ uploadUrl: Type.String(), audioKey: Type.String() }, { $id: "AudioUploadUrlResponse" });
var TranscribeAudioResponse = Type.Object({ text: Type.String(), durationMs: Type.Number() }, { $id: "TranscribeAudioResponse" });
// src/reference/ibjjf-weight-classes.mts
var IBJJF_WEIGHT_CLASSES = {
  male: {
    gi: [
    ...
    nogi: [
      ...
      { division: "light", label: "Light", maxKg: 73.5, maxLb: 162 },
      ...
      { division: "super_heavy", label: "Super Heavy", maxKg: 97.5, maxLb: 215 },
      { division: "ultra_heavy", label: "Ultra Heavy", maxKg: null, maxLb: null }
    ]
  },
  female: {
    gi: [
      ...
      { division: "feather", label: "Feather", maxKg: 58.5, maxLb: 129 },
...
function divisionsFor(gender2, context) {
  return IBJJF_WEIGHT_CLASSES[gender2][context];
}
export {
  divisionsFor,
  WeightDivision,
